...
add_filter( 'rwmb_meta_boxes', 'subsite_register_meta_boxes' );
 ...
 * @return void
 */
function subsite_register_meta_boxes( $meta_boxes )
{
	/**
	...
	$meta_boxes[] = array(
		...
		'title' => __( 'Subsite Fields', 'meta-box' ),
		...
		'fields' => array(			
			array(
				'name' => __( 'This is the top level of a sub-site', 'meta-box' ),
				'id'   => "{$prefix}checkbox",
				'type' => 'checkbox',
				// Value can be 0 or 1
				'std'  => 0,
			...
			array(
				'name' => __( 'Title and link colour', 'meta-box' ),
				'id'   => "{$prefix}color",
				'desc'  => __( 'Must not be too light, for readablity.', 'meta-box' ), 
				'type' => 'color',
			),
